...
pageType: contact
title: Contact
description: How to reach the Ambedkar King Study Circle, and where to take an enquiry that needs confidential support.
eyebrow: Get in touch
intro: Write to us about the organisation’s work, or follow the channels below for regular updates. If you are dealing with caste discrimination yourself, the anti-caste helpline is the better place to start.
channels:
  - title: Best way to reach us
    description: For a quick response, please email us.
    actionLabel: ec@akscusa.org
    actionHref: mailto:ec@akscusa.org
